...
Transport: stdio JSON (compatible with MCP protocol).
"""
...
TOOL_REGISTRY: dict[str, dict[str, Any]] = {
    "ids_get_mcp_status": {
        "fn": ids_get_mcp_status,
        "params": [],
    },
    "ids_list_capabilities": {
        "fn": ids_list_capabilities,
        "params": [],
    },
    "ids_get_core_status": {
        "fn": ids_get_core_status,
        "params": [],
    },
    "ids_get_recent_events": {
        "fn": ids_get_recent_events,
        "params": [
            {"name": "limit", "type": "int", "default": 20, "description": "Number of events (1-100)"},
        ],
    },
    "ids_summarize_recent_events": {
        "fn": ids_summarize_recent_events,
        "params": [],
    },
    "ids_score_event_readonly": {
        "fn": ids_score_event_readonly,
        "params": [
            {"name": "event", "type": "object", "description": "Normalized IDS event to score"},
        ],
    },
    "ids_read_suricata_plan": {
        "fn": ids_read_suricata_plan,
        "params": [],
    },
}
